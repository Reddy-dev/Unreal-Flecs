...
BEGIN_DEFINE_SPEC(FStrBufFlecsTestsSpec,
                  "FlecsLibrary.Collections.StrBuf",
...
END_DEFINE_SPEC(FStrBufFlecsTestsSpec);

void FStrBufFlecsTestsSpec::Define()
{
	Describe("StrBuf Append", [this]()
    {
        It("Should append strings", [this]() { Strbuf_append(); });
        It("Should append strings with str", [this]() { Strbuf_appendstr(); });
        It("Should append strings with strn", [this]() { Strbuf_appendstrn(); });
        It("Should append lists", [this]() { Strbuf_append_list(); });
        It("Should append nested lists", [this]() { Strbuf_append_nested_list(); });
        It("Should append large strings", [this]() { Strbuf_large_str(); });
    });

    Describe("StrBuf Empty", [this]()
    {
        It("Should return empty string", [this]() { Strbuf_empty_str(); });
        It("Should reset string", [this]() { Strbuf_reset(); });
    });

    Describe("StrBuf Merge", [this]()
    {
        It("Should merge strings", [this]() { Strbuf_merge(); });
        It("Should merge empty strings", [this]() { Strbuf_merge_empty(); });
    });

    Describe("StrBuf Append Char", [this]()
    {
        It("Should append char", [this]() { Strbuf_append_char(); });
        It("Should append 511 chars", [this]() { Strbuf_append_511_chars(); });
        It("Should append 512 chars", [this]() { Strbuf_append_512_chars(); });
        It("Should append 513 chars", [this]() { Strbuf_append_513_chars(); });
        It("Should append 1023 chars", [this]() { Strbuf_append_1023_chars(); });
        It("Should append 1024 chars", [this]() { Strbuf_append_1024_chars(); });
        It("Should append 1025 chars", [this]() { Strbuf_append_1025_chars(); });
        It("Should append 2047 chars", [this]() { Strbuf_append_2047_chars(); });
        It("Should append 2048 chars", [this]() { Strbuf_append_2048_chars(); });
        It("Should append 2049 chars", [this]() { Strbuf_append_2049_chars(); });
    });

    Describe("StrBuf Append Str", [this]()
    {
        It("Should append 511 str", [this]() { Strbuf_append_511_str(); });
        It("Should append 512 str", [this]() { Strbuf_append_512_str(); });
        It("Should append 513 str", [this]() { Strbuf_append_513_str(); });
        It("Should append 1023 str", [this]() { Strbuf_append_1023_str(); });
        It("Should append 1024 str", [this]() { Strbuf_append_1024_str(); });
        It("Should append 1025 str", [this]() { Strbuf_append_1025_str(); });
        It("Should append 2047 str", [this]() { Strbuf_append_2047_str(); });
        It("Should append 2048 str", [this]() { Strbuf_append_2048_str(); });
        It("Should append 2049 str", [this]() { Strbuf_append_2049_str(); });
    });

    Describe("StrBuf Append Flt", [this]()
    {
        It("Should append flt", [this]() { Strbuf_append_flt(); });
        It("Should append nan", [this]() { Strbuf_append_nan(); });
        It("Should append inf", [this]() { Strbuf_append_inf(); });
        It("Should append nan with delim", [this]() { Strbuf_append_nan_delim(); });
        It("Should append inf with delim", [this]() { Strbuf_append_inf_delim(); });
    });

    Describe("StrBuf Append Ch", [this]()
    {
        It("Should append ch", [this]() { Strbuf_append_char(); });
    });
}
