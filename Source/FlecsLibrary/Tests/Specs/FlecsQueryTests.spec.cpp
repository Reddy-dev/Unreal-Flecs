...
void FFlecsQueryTestsSpec::Define()
{
	...
	It("Query_dont_fragment_trait_registered", [&]() { Query_dont_fragment_trait_registered(); });
	It("Query_dont_fragment_trait_specialized_registered", [&]() { Query_dont_fragment_trait_specialized_registered(); });
	It("Query_each_dont_fragment_trait", [&]() { Query_each_dont_fragment_trait(); });
	It("Query_each_dont_fragment_trait_mixed", [&]() { Query_each_dont_fragment_trait_mixed(); });
	It("Query_each_dont_fragment_trait_shared", [&]() { Query_each_dont_fragment_trait_shared(); });
	It("Query_each_optional_sparse", [&]() { Query_each_optional_sparse(); });
	It("Query_sparse_query_type", [&]() { Query_sparse_query_type(); });
	It("Query_sparse_query_each", [&]() { Query_sparse_query_each(); });
	It("Query_sparse_query_empty", [&]() { Query_sparse_query_empty(); });
	It("Query_sparse_query_recycled_entity", [&]() { Query_sparse_query_recycled_entity(); });
	It("Query_sparse_query_skip_prefab_disabled", [&]() { Query_sparse_query_skip_prefab_disabled(); });
	It("Query_sparse_query_type_on_instantiate", [&]() { Query_sparse_query_type_on_instantiate(); });
	It("Query_sparse_query_type_no_on_instantiate", [&]() { Query_sparse_query_type_no_on_instantiate(); });
	It("Query_sparse_query_each_on_instantiate_override", [&]() { Query_sparse_query_each_on_instantiate_override(); });
	It("Query_sparse_query_each_on_instantiate_dont_inherit", [&]() { Query_sparse_query_each_on_instantiate_dont_inherit(); });
	It("Query_sparse_query_each_on_instantiate_mixed_terms", [&]() { Query_sparse_query_each_on_instantiate_mixed_terms(); });
	It("Query_sparse_query_dynamic_inherit_1_term", [&]() { Query_sparse_query_dynamic_inherit_1_term(); });
	It("Query_sparse_query_dynamic_inherit_3_terms", [&]() { Query_sparse_query_dynamic_inherit_3_terms(); });
	It("Query_sparse_query_dynamic_dont_inherit", [&]() { Query_sparse_query_dynamic_dont_inherit(); });
	It("Query_sparse_query_convert_to_query_1_term", [&]() { Query_sparse_query_convert_to_query_1_term(); });
	It("Query_sparse_query_convert_to_query_3_terms", [&]() { Query_sparse_query_convert_to_query_3_terms(); });
	It("Query_world_each_sparse", [&]() { Query_world_each_sparse(); });
	It("Query_world_each_sparse_w_entity", [&]() { Query_world_each_sparse_w_entity(); });
}
