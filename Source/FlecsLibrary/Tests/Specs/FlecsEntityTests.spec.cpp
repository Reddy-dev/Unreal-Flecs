...
void Entity_each_w_dont_fragment_component(void) {
    flecs::world world;
	world.component<EachDontFragment>();
	world.component<OtherDontFragment>();
...
void FFlecsEntityTestsSpec::Define()
{
	...
	It("Entity_each_w_dont_fragment_component", [&]() { Entity_each_w_dont_fragment_component(); });
	It("Entity_each_w_dont_fragment_tag", [&]() { Entity_each_w_dont_fragment_tag(); });
	It("Entity_each_w_dont_fragment_pair", [&]() { Entity_each_w_dont_fragment_pair(); });
	It("Entity_each_w_only_dont_fragment", [&]() { Entity_each_w_only_dont_fragment(); });
	It("Entity_each_w_only_dont_fragment_tag", [&]() { Entity_each_w_only_dont_fragment_tag(); });
	It("Entity_each_w_only_dont_fragment_pair", [&]() { Entity_each_w_only_dont_fragment_pair(); });
	It("Entity_each_pair_w_dont_fragment_mixed", [&]() { Entity_each_pair_w_dont_fragment_mixed(); });
	It("Entity_each_rel_w_dont_fragment_mixed", [&]() { Entity_each_rel_w_dont_fragment_mixed(); });
	It("Entity_each_pair_w_dont_fragment", [&]() { Entity_each_pair_w_dont_fragment(); });
	It("Entity_each_rel_w_dont_fragment", [&]() { Entity_each_rel_w_dont_fragment(); });
	...
	It("Entity_defer_set_parent_to_deleted", [&]() { Entity_defer_set_parent_to_deleted(); });
	It("Entity_defer_set_parent_to_deleted_batched", [&]() { Entity_defer_set_parent_to_deleted_batched(); });
	It("Entity_defer_set_existing_parent_to_deleted", [&]() { Entity_defer_set_existing_parent_to_deleted(); });
	It("Entity_defer_set_existing_parent_to_deleted_batched", [&]() { Entity_defer_set_existing_parent_to_deleted_batched(); });
	It("Entity_defer_assign_parent_to_deleted", [&]() { Entity_defer_assign_parent_to_deleted(); });
	It("Entity_defer_assign_parent_to_deleted_batched", [&]() { Entity_defer_assign_parent_to_deleted_batched(); });
