...
void ComponentTraits_dont_fragment_implicit(void) {
    ...
    world.component<TraitDontFragment>();
...
void ComponentTraits_on_instantiate_override_implicit(void) {
    ...
    world.component<TraitOnInstantiateOverride>();
...
void ComponentTraits_on_instantiate_inherit_implicit(void) {
    ...
    world.component<TraitOnInstantiateInherit>();
...
void ComponentTraits_on_instantiate_dont_inherit_implicit(void) {
    ...
    world.component<TraitOnInstantiateDontInherit>();
...
void ComponentTraits_on_instantiate_specialized_implicit(void) {
    ...
    world.component<TraitOnInstantiateSpecialized>();
...
void ComponentTraits_dont_fragment_dont_inherit_implicit(void) {
    ...
    world.component<TraitDontFragmentDontInherit>();
...
void ComponentTraits_static_inherit_sparse_inherited(void) {
    ...
    world.component<TraitSparseInherit>();
...
void ComponentTraits_static_inherit_dont_fragment_inherited(void) {
    ...
    world.component<TraitDontFragmentInherit>();
...
{
    It("ComponentTraits_dont_fragment_explicit", [&]()
    {
        ComponentTraits_dont_fragment_explicit();
    });

    It("ComponentTraits_dont_fragment_implicit", [&]()
    {
        ComponentTraits_dont_fragment_implicit();
    });

    It("ComponentTraits_on_instantiate_override_explicit", [&]()
    {
        ComponentTraits_on_instantiate_override_explicit();
    });

    It("ComponentTraits_on_instantiate_override_implicit", [&]()
    {
        ComponentTraits_on_instantiate_override_implicit();
    });

    It("ComponentTraits_on_instantiate_inherit_explicit", [&]()
    {
        ComponentTraits_on_instantiate_inherit_explicit();
    });

    It("ComponentTraits_on_instantiate_inherit_implicit", [&]()
    {
        ComponentTraits_on_instantiate_inherit_implicit();
    });

    It("ComponentTraits_on_instantiate_dont_inherit_explicit", [&]()
    {
        ComponentTraits_on_instantiate_dont_inherit_explicit();
    });

    It("ComponentTraits_on_instantiate_dont_inherit_implicit", [&]()
    {
        ComponentTraits_on_instantiate_dont_inherit_implicit();
    });

    It("ComponentTraits_on_instantiate_specialized_explicit", [&]()
    {
        ComponentTraits_on_instantiate_specialized_explicit();
    });

    It("ComponentTraits_on_instantiate_specialized_implicit", [&]()
    {
        ComponentTraits_on_instantiate_specialized_implicit();
    });

    It("ComponentTraits_dont_fragment_dont_inherit_explicit", [&]()
    {
        ComponentTraits_dont_fragment_dont_inherit_explicit();
    });

    It("ComponentTraits_dont_fragment_dont_inherit_implicit", [&]()
    {
        ComponentTraits_dont_fragment_dont_inherit_implicit();
    });

    It("ComponentTraits_no_traits_explicit", [&]()
    {
        ComponentTraits_no_traits_explicit();
    });

    It("ComponentTraits_no_traits_implicit", [&]()
    {
        ComponentTraits_no_traits_implicit();
    });

    It("ComponentTraits_sparse_explicit", [&]()
    {
        ComponentTraits_sparse_explicit();
    });

    It("ComponentTraits_sparse_implicit", [&]()
    {
        ComponentTraits_sparse_implicit();
    });

    It("ComponentTraits_sparse_specialized", [&]()
    {
        ComponentTraits_sparse_specialized();
    });

    It("ComponentTraits_sparse_get_get_mut", [&]()
    {
        ComponentTraits_sparse_get_get_mut();
    });

    It("ComponentTraits_sparse_try_get_not_found", [&]()
    {
        ComponentTraits_sparse_try_get_not_found();
    });

    It("ComponentTraits_dont_fragment_get_get_mut", [&]()
    {
        ComponentTraits_dont_fragment_get_get_mut();
    });

    It("ComponentTraits_on_instantiate_override_get_get_mut", [&]()
    {
        ComponentTraits_on_instantiate_override_get_get_mut();
    });

    It("ComponentTraits_on_instantiate_dont_inherit_get_get_mut", [&]()
    {
        ComponentTraits_on_instantiate_dont_inherit_get_get_mut();
    });

    It("ComponentTraits_on_instantiate_inherit_get_inherited", [&]()
    {
        ComponentTraits_on_instantiate_inherit_get_inherited();
    });

    It("ComponentTraits_no_traits_get_inherited", [&]()
    {
        ComponentTraits_no_traits_get_inherited();
    });

    It("ComponentTraits_get_dispatch", [&]()
    {
        ComponentTraits_get_dispatch();
    });

    It("ComponentTraits_dynamic_inherit_dense_owned", [&]()
    {
        ComponentTraits_dynamic_inherit_dense_owned();
    });

    It("ComponentTraits_dynamic_inherit_dense_inherited", [&]()
    {
        ComponentTraits_dynamic_inherit_dense_inherited();
    });

    It("ComponentTraits_static_inherit_dense_owned", [&]()
    {
        ComponentTraits_static_inherit_dense_owned();
    });

    It("ComponentTraits_static_inherit_dense_inherited", [&]()
    {
        ComponentTraits_static_inherit_dense_inherited();
    });

    It("ComponentTraits_static_inherit_sparse_owned", [&]()
    {
        ComponentTraits_static_inherit_sparse_owned();
    });

    It("ComponentTraits_static_inherit_sparse_inherited", [&]()
    {
        ComponentTraits_static_inherit_sparse_inherited();
    });

    It("ComponentTraits_static_inherit_dont_fragment_owned", [&]()
    {
        ComponentTraits_static_inherit_dont_fragment_owned();
    });

    It("ComponentTraits_static_inherit_dont_fragment_inherited", [&]()
    {
