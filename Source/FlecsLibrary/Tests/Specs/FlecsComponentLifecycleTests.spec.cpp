...
void ComponentLifecycle_dtor_w_non_trivial_implicit_move(void) {
    flecs::world ecs;
    ecs.component<CtorDtorNonTrivial>();
...
void ComponentLifecycle_dtor_w_non_trivial_explicit_move(void) {
    flecs::world ecs;
    ecs.component<CtorDtor_w_MoveAssign>();
...
void ComponentLifecycle_defer_emplace(void) {
    flecs::world ecs;
    ecs.component<DeferEmplaceTest>();
...
void ComponentLifecycle_move_ctor_no_default_ctor(void) {
    ...
    world.component<Tag>();
    world.component<NonDefaultConstructible>();
...
static void ResetComponentLifecycleTestState()
{
    Pod::ctor_invoked = 0;
    Pod::dtor_invoked = 0;
    Pod::copy_invoked = 0;
    Pod::move_invoked = 0;
    Pod::copy_ctor_invoked = 0;
    Pod::move_ctor_invoked = 0;

    CountNoDefaultCtor::reset();

    CtorDtorNonTrivial::ctor_invoked = 0;
    CtorDtorNonTrivial::dtor_invoked = 0;
    CtorDtorNonTrivial::dtor_value = 0;

    CtorDtor_w_MoveAssign::ctor_invoked = 0;
    CtorDtor_w_MoveAssign::dtor_invoked = 0;
    CtorDtor_w_MoveAssign::dtor_value = 0;
    CtorDtor_w_MoveAssign::move_value = 0;
}

void FFlecsComponentLifecycleTestsSpec::Define()
{
	It("ComponentLifecycle_ctor_on_add", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_ctor_on_add(); });
	It("ComponentLifecycle_dtor_on_remove", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_dtor_on_remove(); });
	It("ComponentLifecycle_move_on_add", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_move_on_add(); });
	It("ComponentLifecycle_move_on_remove", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_move_on_remove(); });
	It("ComponentLifecycle_copy_on_set", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_copy_on_set(); });
	It("ComponentLifecycle_copy_on_override", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_copy_on_override(); });
	It("ComponentLifecycle_struct_w_string_add", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_struct_w_string_add(); });
	It("ComponentLifecycle_struct_w_string_remove", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_struct_w_string_remove(); });
	It("ComponentLifecycle_struct_w_string_set", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_struct_w_string_set(); });
	It("ComponentLifecycle_struct_w_string_override", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_struct_w_string_override(); });
	It("ComponentLifecycle_struct_w_string_add_2_remove", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_struct_w_string_add_2_remove(); });
	It("ComponentLifecycle_struct_w_string_set_2_remove", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_struct_w_string_set_2_remove(); });
	It("ComponentLifecycle_struct_w_string_add_2_remove_w_tag", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_struct_w_string_add_2_remove_w_tag(); });
	It("ComponentLifecycle_struct_w_string_set_2_remove_w_tag", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_struct_w_string_set_2_remove_w_tag(); });
	It("ComponentLifecycle_struct_w_vector_add", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_struct_w_vector_add(); });
	It("ComponentLifecycle_struct_w_vector_remove", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_struct_w_vector_remove(); });
	It("ComponentLifecycle_struct_w_vector_set", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_struct_w_vector_set(); });
	It("ComponentLifecycle_struct_w_vector_override", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_struct_w_vector_override(); });
	It("ComponentLifecycle_struct_w_vector_add_2_remove", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_struct_w_vector_add_2_remove(); });
	It("ComponentLifecycle_struct_w_vector_set_2_remove", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_struct_w_vector_set_2_remove(); });
	It("ComponentLifecycle_struct_w_vector_add_2_remove_w_tag", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_struct_w_vector_add_2_remove_w_tag(); });
	It("ComponentLifecycle_struct_w_vector_set_2_remove_w_tag", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_struct_w_vector_set_2_remove_w_tag(); });
	It("ComponentLifecycle_ensure_new", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_ensure_new(); });
	It("ComponentLifecycle_ensure_existing", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_ensure_existing(); });
	It("ComponentLifecycle_implicit_component", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_implicit_component(); });
	It("ComponentLifecycle_implicit_after_query", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_implicit_after_query(); });
	It("ComponentLifecycle_deleted_copy", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_deleted_copy(); });
	It("ComponentLifecycle_no_default_ctor_emplace", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_no_default_ctor_emplace(); });
	It("ComponentLifecycle_default_init", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_default_init(); });
	It("ComponentLifecycle_no_copy_ctor", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_no_copy_ctor(); });
	It("ComponentLifecycle_no_move", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_no_move(); });
	It("ComponentLifecycle_no_move_ctor", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_no_move_ctor(); });
	It("ComponentLifecycle_no_move_assign", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_no_move_assign(); });
	It("ComponentLifecycle_no_copy_assign", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_no_copy_assign(); });
	It("ComponentLifecycle_no_copy", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_no_copy(); });
	It("ComponentLifecycle_default_ctor_w_value_ctor", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_default_ctor_w_value_ctor(); });
	It("ComponentLifecycle_no_default_ctor_move_ctor_on_set", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_no_default_ctor_move_ctor_on_set(); });
	It("ComponentLifecycle_emplace_w_ctor", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_emplace_w_ctor(); });
	It("ComponentLifecycle_emplace_no_default_ctor", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_emplace_no_default_ctor(); });
	It("ComponentLifecycle_emplace_defer_use_move_ctor", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_emplace_defer_use_move_ctor(); });
	It("ComponentLifecycle_emplace_singleton", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_emplace_singleton(); });
	It("ComponentLifecycle_dtor_w_non_trivial_implicit_move", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_dtor_w_non_trivial_implicit_move(); });
	It("ComponentLifecycle_dtor_w_non_trivial_explicit_move", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_dtor_w_non_trivial_explicit_move(); });
	It("ComponentLifecycle_grow_no_default_ctor", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_grow_no_default_ctor(); });
	It("ComponentLifecycle_grow_no_default_ctor_move", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_grow_no_default_ctor_move(); });
	It("ComponentLifecycle_grow_no_default_ctor_move_w_component", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_grow_no_default_ctor_move_w_component(); });
	It("ComponentLifecycle_delete_no_default_ctor", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_delete_no_default_ctor(); });
	It("ComponentLifecycle_on_add_hook", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_on_add_hook(); });
	It("ComponentLifecycle_on_remove_hook", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_on_remove_hook(); });
	It("ComponentLifecycle_on_set_hook", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_on_set_hook(); });
	It("ComponentLifecycle_on_add_hook_w_entity", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_on_add_hook_w_entity(); });
	It("ComponentLifecycle_on_remove_hook_w_entity", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_on_remove_hook_w_entity(); });
	It("ComponentLifecycle_on_set_hook_w_entity", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_on_set_hook_w_entity(); });
	It("ComponentLifecycle_on_add_hook_sparse", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_on_add_hook_sparse(); });
	It("ComponentLifecycle_on_remove_hook_sparse", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_on_remove_hook_sparse(); });
	It("ComponentLifecycle_on_set_hook_sparse", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_on_set_hook_sparse(); });
	It("ComponentLifecycle_on_add_hook_sparse_w_entity", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_on_add_hook_sparse_w_entity(); });
	It("ComponentLifecycle_on_remove_hook_sparse_w_entity", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_on_remove_hook_sparse_w_entity(); });
	It("ComponentLifecycle_on_set_hook_sparse_w_entity", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_on_set_hook_sparse_w_entity(); });
	It("ComponentLifecycle_on_add_hook_sparse_w_iter", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_on_add_hook_sparse_w_iter(); });
	It("ComponentLifecycle_on_remove_hook_sparse_w_iter", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_on_remove_hook_sparse_w_iter(); });
	It("ComponentLifecycle_on_set_hook_sparse_w_iter", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_on_set_hook_sparse_w_iter(); });
	It("ComponentLifecycle_chained_hooks", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_chained_hooks(); });
	It("ComponentLifecycle_ctor_w_2_worlds", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_ctor_w_2_worlds(); });
	It("ComponentLifecycle_ctor_w_2_worlds_explicit_registration", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_ctor_w_2_worlds_explicit_registration(); });
	It("ComponentLifecycle_defer_emplace", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_defer_emplace(); });
	It("ComponentLifecycle_emplace_w_on_add", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_emplace_w_on_add(); });
	It("ComponentLifecycle_emplace_w_on_add_existing", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_emplace_w_on_add_existing(); });
	It("ComponentLifecycle_set_pair_no_copy", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_set_pair_no_copy(); });
	It("ComponentLifecycle_set_pair_w_entity_no_copy", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_set_pair_w_entity_no_copy(); });
	It("ComponentLifecycle_set_pair_second_no_copy", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_set_pair_second_no_copy(); });
	It("ComponentLifecycle_set_override_no_copy", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_set_override_no_copy(); });
	It("ComponentLifecycle_set_override_pair_no_copy", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_set_override_pair_no_copy(); });
	It("ComponentLifecycle_set_override_pair_w_entity_no_copy", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_set_override_pair_w_entity_no_copy(); });
	It("ComponentLifecycle_dtor_after_defer_set", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_dtor_after_defer_set(); });
	It("ComponentLifecycle_dtor_with_relation", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_dtor_with_relation(); });
	It("ComponentLifecycle_register_parent_after_child_w_hooks", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_register_parent_after_child_w_hooks(); });
	It("ComponentLifecycle_register_parent_after_child_w_hooks_implicit", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_register_parent_after_child_w_hooks_implicit(); });
	It("ComponentLifecycle_dtor_relation_target", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_dtor_relation_target(); });
	It("ComponentLifecycle_sparse_component", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_sparse_component(); });
	It("ComponentLifecycle_count_in_add_hook", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_count_in_add_hook(); });
	It("ComponentLifecycle_count_in_remove_hook", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_count_in_remove_hook(); });
	It("ComponentLifecycle_set_multiple_hooks", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_set_multiple_hooks(); });
	It("ComponentLifecycle_compare_WithGreaterThan", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_compare_WithGreaterThan(); });
	It("ComponentLifecycle_compare_WithLessThan", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_compare_WithLessThan(); });
	It("ComponentLifecycle_compare_WithLessAndGreaterThan", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_compare_WithLessAndGreaterThan(); });
	It("ComponentLifecycle_compare_WithEqualsAndGreaterThan", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_compare_WithEqualsAndGreaterThan(); });
	It("ComponentLifecycle_compare_WithEqualsAndLessThan", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_compare_WithEqualsAndLessThan(); });
	It("ComponentLifecycle_compare_WithEqualsOnly", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_compare_WithEqualsOnly(); });
	It("ComponentLifecycle_compare_WithoutOperators", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_compare_WithoutOperators(); });
	It("ComponentLifecycle_compare_uint8_Enum", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_compare_uint8_Enum(); });
	It("ComponentLifecycle_compare_uint16_Enum", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_compare_uint16_Enum(); });
	It("ComponentLifecycle_compare_uint32_Enum", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_compare_uint32_Enum(); });
	It("ComponentLifecycle_compare_uint64_Enum", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_compare_uint64_Enum(); });
	It("ComponentLifecycle_compare_int8_Enum", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_compare_int8_Enum(); });
	It("ComponentLifecycle_compare_int16_Enum", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_compare_int16_Enum(); });
	It("ComponentLifecycle_compare_int32_Enum", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_compare_int32_Enum(); });
	It("ComponentLifecycle_compare_int64_Enum", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_compare_int64_Enum(); });
	It("ComponentLifecycle_move_ctor_no_default_ctor", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_move_ctor_no_default_ctor(); });
	It("ComponentLifecycle_on_validate_hook", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_on_validate_hook(); });
	It("ComponentLifecycle_on_validate_hook_blocks_on_set", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_on_validate_hook_blocks_on_set(); });
	It("ComponentLifecycle_on_validate_hook_blocks_observer", [&]() { ResetComponentLifecycleTestState(); ComponentLifecycle_on_validate_hook_blocks_observer(); });
}
