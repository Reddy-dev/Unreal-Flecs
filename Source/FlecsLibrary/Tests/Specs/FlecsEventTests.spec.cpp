...
BEGIN_DEFINE_SPEC(FFlecsEventTestsSpec,
                  "FlecsLibrary.Event",
...
END_DEFINE_SPEC(FFlecsEventTestsSpec);
...
void FFlecsEventTestsSpec::Define()
{
	It("Event_evt_1_id_entity", [this]() { Event_evt_1_id_entity(); });
    It("Event_evt_2_ids_entity", [this]() { Event_evt_2_ids_entity(); });
    It("Event_evt_1_id_table", [this]() { Event_evt_1_id_table(); });
    It("Event_evt_2_ids_table", [this]() { Event_evt_2_ids_table(); });
    It("Event_evt_type", [this]() { Event_evt_type(); });
    It("Event_evt_1_component", [this]() { Event_evt_1_component(); });
    It("Event_evt_2_components", [this]() { Event_evt_2_components(); });
    It("Event_evt_void_ctx", [this]() { Event_evt_void_ctx(); });
    It("Event_evt_typed_ctx", [this]() { Event_evt_typed_ctx(); });
    It("Event_evt_implicit_typed_ctx", [this]() { Event_evt_implicit_typed_ctx(); });
    It("Event_evt_1_id_pair_rel_id_obj_id_entity", [this]() { Event_evt_1_id_pair_rel_id_obj_id_entity(); });
    It("Event_evt_1_id_pair_rel_obj_id_entity", [this]() { Event_evt_1_id_pair_rel_obj_id_entity(); });
    It("Event_evt_1_id_pair_rel_obj_entity", [this]() { Event_evt_1_id_pair_rel_obj_entity(); });
    It("Event_emit_staged_from_world", [this]() { Event_emit_staged_from_world(); });
    It("Event_emit_staged_from_stage", [this]() { Event_emit_staged_from_stage(); });
    It("Event_emit_custom_for_any", [this]() { Event_emit_custom_for_any(); });
    It("Event_entity_emit_event_id", [this]() { Event_entity_emit_event_id(); });
    It("Event_entity_emit_event_type", [this]() { Event_entity_emit_event_type(); });
    It("Event_entity_emit_event_w_payload", [this]() { Event_entity_emit_event_w_payload(); });
    It("Event_entity_emit_event_id_no_src", [this]() { Event_entity_emit_event_id_no_src(); });
    It("Event_entity_emit_event_type_no_src", [this]() { Event_entity_emit_event_type_no_src(); });
    It("Event_entity_emit_event_w_payload_no_src", [this]() { Event_entity_emit_event_w_payload_no_src(); });
    It("Event_entity_emit_event_w_payload_derived_event_type", [this]() { Event_entity_emit_event_w_payload_derived_event_type(); });
    It("Event_entity_emit_event_w_payload_derived_event_type_no_src", [this]() { Event_entity_emit_event_w_payload_derived_event_type_no_src(); });
    It("Event_entity_observe_generic", [this]() { Event_entity_observe_generic(); });
    It("Event_enqueue_event", [this]() { Event_enqueue_event(); });
    It("Event_enqueue_entity_event", [this]() { Event_enqueue_entity_event(); });
    It("Event_enqueue_event_w_payload", [this]() { Event_enqueue_event_w_payload(); });
    It("Event_enqueue_entity_event_w_payload", [this]() { Event_enqueue_entity_event_w_payload(); });
    It("Event_enqueue_entity_from_readonly_world", [this]() { Event_enqueue_entity_from_readonly_world(); });
    It("Event_enqueue_entity_w_payload_from_readonly_world", [this]() { Event_enqueue_entity_w_payload_from_readonly_world(); });
    It("Event_enum_event", [this]() { Event_enum_event(); });
}
