...
void flecs_register_trait(ecs_iter_t *it) {
    const ecs_on_trait_ctx_t *ctx = static_cast<const ecs_on_trait_ctx_t*>(it->ctx);
    ...
    ecs_size_t alignment)
{
    ...
    EcsComponent *component = static_cast<EcsComponent*>(columns[0].data);
    ...
    EcsIdentifier *name_col = static_cast<EcsIdentifier*>(columns[1].data);
    ...
    EcsIdentifier *symbol_col = static_cast<EcsIdentifier*>(columns[2].data);
    ...
    ecs_world_t *world)
{
    ...
    result->data.entities = static_cast<ecs_entity_t*>(v_entities.array);
    result->data.count = 0;
