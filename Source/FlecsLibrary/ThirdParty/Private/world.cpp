    ...
    ecs_ftime_t user_delta_time)
{
    ...
    world->on_commands = nullptr;

    world->on_commands_ctx_active = world->on_commands_ctx;
    world->on_commands_ctx = nullptr;
    ...
    ecs_world_t *world)
{
    ...
    world->on_commands_active = nullptr;
    world->on_commands_ctx_active = nullptr;
    ...
    const ecs_world_t *world_r)
{
    ...
    flecs_journal_begin(world, EcsJournalTableEvents, 0, nullptr, nullptr);
