...
REGISTER_FLECS_COMPONENT(FFlecsTestStruct_WithTypeRequirementA);
REGISTER_FLECS_COMPONENT(FFlecsTestStruct_WithTypeRequirementB);
REGISTER_FLECS_COMPONENT(FFlecsTestStruct_WithTypes);
REGISTER_FLECS_COMPONENT(FFlecsTestStruct_CustomTraitA);
REGISTER_FLECS_COMPONENT(FFlecsTestStruct_CustomTraitB);
REGISTER_FLECS_COMPONENT(FFlecsTestStruct_WithCustomTraits);
