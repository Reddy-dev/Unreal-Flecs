...
REGISTER_FLECS_COMPONENT(FFlecsViewerStreamingSourceComponent);
REGISTER_FLECS_COMPONENT(FFlecsViewerPlayerComponent);
REGISTER_FLECS_COMPONENT(FFlecsViewerActorComponent);