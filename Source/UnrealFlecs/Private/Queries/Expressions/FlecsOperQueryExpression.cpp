...
#include "Queries/Expressions/FlecsOperQueryExpression.h"
...
void FFlecsOperQueryExpression::Apply(const TSolidNotNull<const UFlecsWorld*> InWorld, flecs::query_builder<>& InQueryBuilder) const
{
