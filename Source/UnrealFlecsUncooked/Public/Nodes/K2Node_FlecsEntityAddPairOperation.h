...
#include "K2Node_FlecsEntityAddPairOperation.generated.h"

struct FFlecsGenericInputPins;

UCLASS()
class UNREALFLECSUNCOOKED_API UK2Node_FlecsEntityAddPairOperation : public UK2Node_FlecsGenericEntityOperation
{
	GENERATED_BODY()
...
}; // class UK2Node_FlecsEntityAddPairOperation
